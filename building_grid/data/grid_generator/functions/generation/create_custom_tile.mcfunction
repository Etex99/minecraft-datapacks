#creates new custom tile

setblock ~ ~-1 ~ minecraft:structure_block[mode=load]{name:"grid_generator:custom1",posY:1,rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
setblock ~ ~-2 ~ minecraft:redstone_block
fill ~ ~-1 ~ ~ ~-2 ~ minecraft:coal_block

setblock ~32 ~-1 ~ minecraft:structure_block[mode=load]{name:"grid_generator:custom2",posY:1,rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
setblock ~32 ~-2 ~ minecraft:redstone_block
fill ~32 ~-1 ~ ~32 ~-2 ~ minecraft:coal_block

setblock ~32 ~-1 ~32 minecraft:structure_block[mode=load]{name:"grid_generator:custom3",posY:1,rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
setblock ~32 ~-2 ~32 minecraft:redstone_block
fill ~32 ~-1 ~32 ~32 ~-2 ~32 minecraft:coal_block

setblock ~ ~-1 ~32 minecraft:structure_block[mode=load]{name:"grid_generator:custom4",posY:1,rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
