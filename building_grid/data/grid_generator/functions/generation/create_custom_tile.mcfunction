...
#place tile
setblock ~ ~ ~ minecraft:structure_block[mode=load]{name:"grid_generator:custom1",rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
setblock ~1 ~ ~ minecraft:redstone_block

setblock ~32 ~ ~ minecraft:structure_block[mode=load]{name:"grid_generator:custom2",rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
setblock ~33 ~ ~ minecraft:redstone_block

setblock ~32 ~ ~32 minecraft:structure_block[mode=load]{name:"grid_generator:custom3",rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
setblock ~33 ~ ~32 minecraft:redstone_block

setblock ~ ~ ~32 minecraft:structure_block[mode=load]{name:"grid_generator:custom4",rotation:"NONE",mirror:"NONE",mode:"LOAD"} replace
