...
tellraw @s {"text":"This is a destructive operation which cannot be undone","color":"red"} 
tellraw @s {"text":"Any existing builds may obstruct the building grid and get overwritten","color":"red"} 
tellraw @s {"text":"Starting out on an empty flatworld is greatly recommended for best performance","color":"red"} 
